...
- Zlecanie zadań automation assistant
...
└──────┬──────┘
       ...
       └──→ automation assistant Context (respond to Slack)
```
...
- [ ] `/ide status` - pokaż aktywne PR i CI/CD
- [ ] `/ide merge <pr_number>` - merge PR
- [ ] `/ide check-ci <pr_number>` - sprawdź CI/CD status
- [ ] MCP Server registration w IDE
...
- [MCP SDK Docs](https://github.com/llm-providers/model-context-protocol)
