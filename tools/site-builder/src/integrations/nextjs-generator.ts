...
export class NextJSGenerator {
  ...
  async generateProject(
    ...
    files.push(await this.generateMainPage(analysis, implementationPrompt));
...
Zwróć TYLKO kod.`;
   ...
   */
  private async generateMainPage(analysis: TemplateAnalysis, implementationPrompt: string): Promise<GeneratedFile> {
